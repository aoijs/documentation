...
This function is only usable in [onChannelUpdate](../events/bot.onchannelupdate.md) and [onChannelDelete](../events/bot.onchanneldelete.md). Examples can be found in the callback page.
